  ...
  setDisplayComponent(false);
    ...
    return (
        <Layout>
            ...
            <ImageBackground resizeMode="center" style={{transform:[{
                rotate:"-10deg"
            }],width:width, height:100, marginTop:height/1.5, position:"absolute"}} source={require("../../assets/plocha.png")}>
                 <Animated.Image style={[{width:240, height:162,opacity:opacityAnim, transform:[{
                     translateX:fadeAnim
